...
<section class="hero"><div class="hero-scene" aria-hidden="true"><img src="/assets/properties/236012/1.jpg" alt="" width="1440" height="1080"></div><div class="container hero-grid"><div class="hero-copy"><p class="eyebrow"><span class="line"></span>VAŠE REALITNÍ MAKLÉŘKA</p><h1><span class="hero-title-line"><span>Vaše nemovitost</span></span><span class="hero-title-line"><em>Moje osobní péče</em></span></h1><p class="hero-description">Provedu vás prodejem, koupí i pronájmem.<br>Srozumitelně a s jistotou.</p><div class="hero-actions"><a href="/kontakt/?tema=prodej" class="button button-featured"><span class="button-label">Chci prodat nemovitost</span>${featuredArrow}</a><a href="/nemovitosti/" class="text-link"><span class="hero-offer-label">Prohlédnout nabídku</span>${arrow}</a></div><p class="hero-trust"><span class="trust-symbol" aria-hidden="true">⌂</span>Více než <strong>10 let</strong> v realitách</p></div><div class="hero-visual"><img src="/assets/petra-pokorna.png" alt="Petra Pokorná, vaše realitní makléřka" width="1000" height="1000" fetchpriority="high"><span class="signature" aria-hidden="true">Petra<span>Pokorná</span></span><span class="hero-visual-caption">NEMOVITOSTI S OSOBNÍM PŘÍSTUPEM</span></div></div></section>
